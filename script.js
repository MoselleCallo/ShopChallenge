...
function AddToCart({ cart, setCart }) { // ADDING ITEMS
    ...
    return (
        <div className="mx-[25px]">
            ...
            <button className="mt-4 mb-20 w-full flex items-center justify-center gap-3 bg-orange-500 font-bold p-4 rounded-md shadow-xl shadow-orange-500/50 hover:opacity-80 active:opacity-70 active:scale-95 transition-all duration-200"
